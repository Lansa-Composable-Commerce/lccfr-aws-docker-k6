      ...
      <div ref={refs.setReference} className="relative">
        <div
          ...
          className={classNames([
            "w-full h-[50px] lg:h-[60px] rounded-lg lg:rounded-large flex items-center gap-8 relative font-normal text-black01 text-base py-3 lg:py-3.5 ring-inset px-2 lg:px-3 dark:text-gray-300 hover:ring-primary-700 active:ring-primary-700 active:ring-2 focus:ring-primary-700 focus:ring-2 focus-visible:outline focus-visible:outline-offset",
            {
              "ring-2 ring-red-700": invalid,
              "bg-gray-400 hover:ring-gray-400 text-black01/50 !cursor-not-allowed":
                disabled,
        ...
        >
          {selectedOption ? (
            ...
            <span className="text-base w-full text-gray-500 ml-2 dark:text-gray-400">
